    ...
    <BrowserRouter>
      <nav className="flex space-x-1 bg-slate-800 text-white">
        <Link className="px-4 text-3xl font-bold hover:text-blue-300" to="/">App Rotas</Link>
          <Link className='bg-blue-400 hover:bg-blue-900 p-2 px-10' to="/">Home</Link>
          <Link className='bg-blue-400 hover:bg-blue-900 p-2 px-10' to="/sobre">Sobre</Link>
          <Link className='bg-blue-400 hover:bg-blue-900 p-2 px-10' to="/contato">Contato</Link>
      </nav>
